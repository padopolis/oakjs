...
function(Class, Property, Widget) {
	new Class("Panel", "Widget", {
		...
		_setClassesForCurrentState : function() {
			if (this.$root) {
				this.$root.toggleClass("fullSize", !!this.fullSize)
						  ...
						  .toggleClass("showingLoadingMessage", !!this.showingLoadingMessage)
		...
		// Set `showingLoadingMessage=true` to show a loading message automatically.
		showingLoadingMessage : Property.onChange(function(){ this._setClassesForCurrentState(); }),
