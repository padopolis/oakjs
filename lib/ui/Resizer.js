...
//				console.dir(item);
	...
	//
		...
		onResizeStarted : function(event, resizeInfo) {
			...
			// HACK: jQuery UI doesn't take borders into account when calculating sizes, which throws things off.
			//		 Hacking in the outer size in the originalSize seems to fix it.
			resizeInfo.originalSize.width = resizeInfo.originalElement.outerWidth();
			resizeInfo.originalSize.height = resizeInfo.originalElement.outerHeight();
